        ...
        <div className="rounded-2xl border border-border bg-card p-8 sm:p-10">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-xl">
              <p className="mb-2 font-mono text-xs uppercase tracking-widest text-accent">Download</p>
              <h2 className="text-2xl font-semibold tracking-tight sm:text-3xl">Ready to make GTNH easier to launch?</h2>
              <p className="mt-3 text-muted-foreground">
                Download the Windows desktop launcher. Server hosting is a separate Linux CLI and dashboard in the same project.
              </p>
            </div>
          ...
          <p className="mt-8 border-t border-border pt-6 font-mono text-xs text-muted-foreground">
            Choose the Java runtime your pack needs. A Microsoft account with Minecraft: Java Edition is required for online play.
          </p>
        </div>
      </div>
    </section>
