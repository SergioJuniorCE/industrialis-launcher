...
- Use a Prism-style 3-panel layout with top toolbar (not sidebar) for navigation: Add Instance, Instances/Settings/Accounts toggles, instance list on left, tabbed details panel on right, status bar on bottom. Confidence: 0.60
